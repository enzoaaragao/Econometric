clear all
cap log close
*cd "/Users//`=c(username)'/Dropbox/Metcalf_Stock/stata/_Jim/AERPP_replication"
log using EUctax_IRF_AERPP.txt, text replace
set more off 
set scheme s1color
pause on
*********************************************
...
preserve
 ...
 sort ctaxyear ID
 list country ctaxyear rater_LCU_USD18 share19 
restore
...
global fxlsout "out\AERPP_results.xlsx"
************************************************************
*
* housekeeping
local p $p
